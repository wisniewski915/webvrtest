...
(function (global, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['jquery', './FSRTC', './JsonRpcClient', './adapter'], factory); // AMD
    } else if (typeof module === 'object' && module.exports) {
        module.exports = factory(require('jquery'), require('./FSRTC'), require('./JsonRpcClient'), require('./adapter')); // commonjs
    } else {
        global.Verto = factory(global.jQuery, global.FSRTC, global.JsonRpcClient); // Browser
        if (!global.adapter) console.error('Shims adapter is not found!');
    }
}(this, function($, FSRTC, JsonRpcClient) {
    ...
    /// MASTER OBJ
    function Verto(options, callbacks) {
        var verto = this;
        ...
        verto.rpcClient = new JsonRpcClient({
            ...
            onWSLogin: function(success) {
                if (verto.options.keepalive && !verto.keepalive) {
                    verto.keepalive = setInterval(function() {
                        verto.rpcClient.call('echo');
                    }, verto.options.keepalive);
                }
    ...
    /* @NOTE: dialogs should be stopped explicitly by user
