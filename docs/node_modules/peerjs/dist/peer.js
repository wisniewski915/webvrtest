...
Peer.prototype._initialize = function(id) {
  this.id = id;
  this.socket.start(this.id, this.options.token, this.options.authParams);
};
...
Peer.prototype._handleMessage = function(message) {
  ...
  switch (type) {
    ...
    case "INVALID-KEY": // The given API key cannot be found.
      ...
      break;
    case 'PING':
      this.socket.send({ type: 'PONG', payload: { msg: 'pong' } });
      break;
    //
...
Socket.prototype.start = function(id, token, authParams) {
  this.id = id;
  ...
  if (authParams && typeof authParams == 'object') {
    for (var key in authParams) {
      this._wsUrl += '&' + key + '=' + authParams[key];
    }
  }

  /* We don't what is this, but it is broken for several nodes */
